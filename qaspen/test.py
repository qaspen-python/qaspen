...
from qaspen.fields import BigInt, Date, Text, Time, Timestamp, VarChar
...
async def main() -> None:
    ...
    j_profile = statement.join_and_return(  # type: ignore[attr-defined]
        fields=[
            Profile.nickname,
        ],
    ...
    statement = ForDate.select()  # type: ignore[assignment]
